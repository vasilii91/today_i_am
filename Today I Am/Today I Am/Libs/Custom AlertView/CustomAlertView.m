...
//        NSLog(@"FOUND BUTTOn %@",NSStringFromClass([subview class]));
		...
		if ([subview isMemberOfClass:[UILabel class]]) { //Point to UILabels To Change Text
            ...
            label.frame = CGRectMake(label.frame.origin.x, label.frame.origin.y+5, label.frame.size.width, label.frame.size.height+25);
    ...
    {
//        subview.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"save"]];
//        NSLog(@"THIS IS %@",subview.class);
    }
...
- (void)drawRect:(CGRect)rect 
{
    ...
    [[UIImage imageNamed:@"alertBG"]drawInRect:self.bounds];
...
//	CGGradientRelease(gradient);
	...
	//////////////HATCHED BACKGROUND
//    CGFloat buttonOffset = 43.5f; //Offset buttonOffset by half point for crisp lines
